...
::: {.callout-note}
Si l'on souhaite projeter un objet spatial utilisant des coordonnées géographiques (lon/lat), le package `crsuggest` [@R-crsuggest] propose des systèmes de coordonnées adaptées à l'emprise de l'objet.
