...
[*cheat sheet*](https://raw.githubusercontent.com/riatelab/mapsf/master/vignettes/fig/mapsf_cheatsheet.pdf) : 
...
- [How to create faceted maps](https://riatelab.github.io/mapsf/articles/how_to_create_faceted_maps.html)
- [How to create inset maps](https://riatelab.github.io/mapsf/articles/how_to_create_inset_maps.html)
- [How to export maps](https://riatelab.github.io/mapsf/articles/how_to_export_maps.html)
- [How to use a custom font family](https://riatelab.github.io/mapsf/articles/how_to_use_a_custom_font_family.html)
- [How to use themes](https://riatelab.github.io/mapsf/articles/how_to_use_themes.html)

## Exercice {.unnumbered}

1. Nous utiliserons principalement le package `mapsf` dans la suite de ce document.   
